		...
		<div className='about-container'>
			<div className='about__columns'>
				<div className='about-column'>
					...
					<p>
						Our company specializes in designing and constructing modern skyscrapers that are not only visually
						impressive but also functional and sustainable. With our experience and innovative approach, we deliver
						solutions that exceed our clients expectations.
					</p>
					<p>
						Our team of experts is dedicated to creating buildings that meet the challenges of the modern world,
						including sustainability and energy efficiency. Our projects are a testament to our passion for excellence
						and innovation in architecture and construction.
					</p>
				</div>
				<div className='about-column'>
			...
			<blockquote className='about-quote'>
				...
				<footer className='about__author'>— John Doe, CEO</footer>
			</blockquote>
